...
class PhilipsRdm001RemoteCluster(PhilipsRemoteCluster):
    ...
    # For legacy reasons the button name of the LEFT button in
    # automation triggers needs to be TURN_ON, while in the ZHA event
    # action is LEFT.
    TRIGGER_OVERRIDES = {
        LEFT: TURN_ON
    }
...
class PhilipsROM001(CustomDevice):
    ...
    device_automation_triggers = PhilipsRdm001RemoteCluster.generate_device_automation_triggers()
